...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        searchTgl_jButton.setText("Search");
        searchTgl_jButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                searchTgl_jButtonActionPerformed(evt);
            }
        });

        refreshLaporan_jButton.setText("Refresh Table");
        refreshLaporan_jButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                refreshLaporan_jButtonActionPerformed(evt);
            }
        });
    ...
    private void searchTgl_jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchTgl_jButtonActionPerformed
        try {
            ...
            sql = "select * from transaksi_penjualan where tanggal between'" + tanggal + "' and '" + tanggal2 + "'";
            pst = con.prepareStatement(sql);
            res = pst.executeQuery();
            dataTransaksi_jTable.setModel(DbUtils.resultSetToTableModel(res));
    ...
    }//GEN-LAST:event_searchTgl_jButtonActionPerformed
    ...
    private javax.swing.JButton refreshLaporan_jButton;
    private javax.swing.JButton searchTgl_jButton;
